...
int
CompressEtc1(uint8_t *src, size_t size, int mipmap, float fEffort, int jobs, int header, uint8_t **dst, size_t *filesize);

int
CompressEtc2RGB(uint8_t *src, size_t size, int mipmap, float fEffort, int jobs, int header, uint8_t **dst, size_t *filesize);

int
CompressEtc2RGBA(uint8_t *src, size_t size, int mipmap, float fEffort, int jobs, int header, uint8_t **dst, size_t *filesize);
...
int
CompressAstc(uint8_t *src, size_t size, float fEffort, unsigned int block_x, unsigned int block_y, unsigned int block_z, int header,
...
int DecompressEtc1(uint8_t *src, long w, long h, uint8_t **dst, size_t *filesize);

int DecompressEtc2(uint8_t *src, long w, long h, uint8_t **dst, size_t *filesize);

int DecompressEtc2a1(uint8_t *src, long w, long h, uint8_t **dst, size_t *filesize);

int DecompressEtc2a8(uint8_t *src, long w, long h, uint8_t **dst, size_t *filesize);

int
DecompressAstc(uint8_t *src, long w, long h, long block_width, long block_height, uint8_t **dst, size_t *filesize);
